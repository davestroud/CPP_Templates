...
int main()
{
	...
	{
		cout << "Please input iteger number " << count + 1 << endl;
	...
	cout << "The mean of all the elements in the array is " <<  findMean(arrayValues, total) << endl;
	return 0;
}
